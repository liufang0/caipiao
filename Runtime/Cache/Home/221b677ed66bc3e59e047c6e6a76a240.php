...
<body style="padding:0;margin:0">
    ...
    <div id="root" style="position:absolute;height:100%;width:100%;top:0">
        <div class="main" style="height: 736px;">
            <div>
                <div class="top-title-bar">
                    <div class="am-navbar am-navbar-dark" style="background-color: rgb(229, 49, 52); color: rgb(245, 245, 245); font-weight: 300; height: 45px;">
                        ...
                        <div class="am-navbar-title">资金明细</div>
            ...
            <div style="height: 691px;">
                <div id="me-scroll-bill" class="mescroll mescroll-bar">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div>
                        <div class="billItem">
                            <div class="billItemLeft"><span>提现</span><span><?=date('Y-m-d H:i:s',$vo['addtime'])?></span>
                            </div>
							<?php if($vo['status'] != 1){ ?>
                            <div class="billItemRight"><span style="color: rgb(13, 186, 0);"><?php echo ($vo["money"]); ?></span>
                            </div>
							<?php }else{ ?>
							<div class="billItemRight"><span style="color: rgb(255, 0, 0);">+<?php echo ($vo["money"]); ?></span>
                            </div>
							<?php } ?>
                        </div>
