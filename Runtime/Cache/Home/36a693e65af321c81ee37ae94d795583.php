...
<div class="pay_main" style="margin-top: 0.8rem;">
	...
	<form method="post" action="<?php echo U('Home/Fen/addpage2');?>" id="submitForm">
	<div class="pay_nav_box">
		...
		<div class="pay_form">
			...
			<!--div class="item">
				<div class="t ng-binding">微信户名</div>
				<div class="m"><input type="text" name="username" class="input ng-pristine ng-untouched ng-valid ng-empty" placeholder="请填写您此次转账使用的微信户名"></div>
			</div>
			<div class="item">
				<div class="t ng-binding">微信账号</div>
				<div class="m"><input type="text" name="userpay" class="input ng-pristine ng-untouched ng-valid ng-empty" placeholder="请填写您此次转账使用的微信账号"></div>
			</div-->
		</div>
	</div>
	...
	$(function(){
		...
		function checkForm(){
			...
			/*if ('' == $.trim($('input[name="username"]').val())) {
				layer.alert('微信户名不能为空', {icon: 5}, function (index) {
					layer.close(index);
			...
			if ('' == $.trim($('input[name="userpay"]').val())) {
				layer.alert('微信账号不能为空', {icon: 5}, function (index) {
					layer.close(index);
