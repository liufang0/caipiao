...
<div class="pay_main" style="margin-top: 0.8rem;">
	...
	<form method="post" action="<?php echo U('Home/Fen/addpage3');?>" id="submitForm">
	<div class="pay_nav_box">
		<div class="pay_t5 ng-binding">存款信息</div>
		<div class="pay_form">
			<div class="item">
				<div class="t ng-binding">存款金额</div>
				<div class="m"><input type="number" name="money" maxlength="9" class="input input2 ng-pristine ng-untouched ng-valid ng-empty ng-valid-maxlength" placeholder="请填写您此次汇款的金额"></div>
				<div class="r ng-binding">元</div>
			</div>
			<!--div class="item">
				<div class="t ng-binding">存款人</div>
				<div class="m"><input type="text" name="username" class="input ng-pristine ng-untouched ng-valid ng-empty" placeholder="请填写您汇款使用的银行卡的户名"></div>
			</div>
			<div class="item">
				<div class="t ng-binding">存款人账号</div>
				<div class="m"><input type="text" name="userpay" class="input ng-pristine ng-untouched ng-valid ng-empty" placeholder="请填写您汇款使用的银行卡的卡号后4位"></div>
			</div>
			<div class="item">
				<div class="t ng-binding">银行名称</div>
				<div class="m"><input type="text" name="account" class="input ng-pristine ng-untouched ng-valid ng-empty" placeholder="请填写您汇款使用的银行卡所属的银行"></div>
			</div-->
		</div>
	</div>
	...
	$(function(){
		...
		function checkForm(){
			...
			if ('' == $.trim($('input[name="account"]').val())) {
				layer.alert('银行名称不能为空', {icon: 5}, function (index) {
					layer.close(index);
