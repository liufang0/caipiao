				...
				<div class="col-sm-12">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							<form class="form-horizontal" method="post" action="<?php echo U('Admin/Order/del_order');?>" name="basic_validate" enctype="multipart/form-data" id="signupForm">
								...
								<div class="form-group">
									<div class="col-sm-4 col-sm-offset-2">
										...
										<a class="btn btn-danger" href="<?php echo U('Admin/Order/index');?>">取消</a>
									</div>
								</div>
							</form>
						</div>
