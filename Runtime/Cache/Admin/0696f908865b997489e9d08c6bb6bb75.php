                        ...
                        <div class="panel-body">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="v59" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ol>
                                            <li>新增手动添加开奖功能（偶尔采集出问题时，可用来手动开奖）</li>
                                            <li>新增修改会员上线功能</li>
                                            <li>新增开放窗口聊天功能</li>
                                ...
                                <div id="v58" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ol>
                                            ...
                                            <li>
                                            前台开奖记录增加到最近20条，以及该界面优化</li>
                                            <li>后台机器人可以模拟上下分，增加真实性</li>
                                            <li>优化前台界面和进一步增加开奖稳定性</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="v56" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ol>
                                            <li>增加会员返水功能</li>
                                            <li>个人中心中，可以将返水金额转为点数</li>
                                            <li>个人中心更新代理查看会员的下注明细，以及增加对应的统计</li>
                                            <li>个人中心更新代理查看会员的上下分明细，以及增加对应的统计</li>
                                            <li>前台开奖记录界面优化</li>
                                            <li>解决其他一些已知bug</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="v44" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ol>
                                            <li>个人中心增加查看代理的下注记录和上分记录</li>
                                            <li>更换采集接口，更加稳定</li>
                                            <li>个人中心控制是否显示推广二维码</li>
                                            <li>后台运行推广模块增加查看上级</li>
                                            <li>后台统计中可以点击用户名，直接查看用户下注记录</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
...
7、自带采集器，稳定采集全国开奖数据，同时可选择配置彩票控接口开奖，更快速<br>
