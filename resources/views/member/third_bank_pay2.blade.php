                    ...
                    <div class="con">
                        <ul class="bank-list">
                            <li>
                                ...
                                <input name="bankId" type="radio" value="BOCSH">
                            ...
                            <li>
                                ...
                                <input name="bankId" type="radio" value="BOCOM">
                            ...
                            <li>
                                ...
                                <input name="bankId" type="radio" value="BOS">
                                <img src="{{ asset('/web/images/bank/payh.gif') }}" alt="上海银行" />
                                <input name="bankId" type="radio" value="SRCB">
                                <img src="{{ asset('/web/images/bank/payh.gif') }}" alt="上海农商" />
                            </li>
                            <li>
                                <input name="bankId" type="radio" value="PAB">
                                <img src="{{ asset('/web/images/bank/hxyh.gif') }}" alt="平安银行" />
                                <input name="bankId" type="radio" value="BCCB">
                                <img src="{{ asset('/web/images/bank/xyyh.gif') }}" alt="北京银行" />
                            </li>
                        </ul>
                    </div>
                </div>
