     ...
     <section class="content">
         <div class="panel panel-primary">
             ...
             <div class="panel-body">
                 ...
                 <h3 style="color: red" class="text-center">AG、BBIN、AB、PT、MG、TTG、IBC、YC、CG、SA、BG、DT、HJ、WJS</h3>
                 <h3 style="color: red" class="text-center">以上接口只用填写 BI 这一处接口信息即可，且不要将 BI 接口上线</h3>
