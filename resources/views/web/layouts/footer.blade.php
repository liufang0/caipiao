<footer class="footer ">
    <div class="t6-footer">
        <div class="foot-con">
            <img class="foot-ico" src="{{ asset('/web/images/t6-bottom-ico.jpg') }}">
        </div>
        <p class="foot-sm">COPYRIGHT @ 1998-2016 T6 casino ALL RIGHTS RESERVED<br>{{ $_system_config->site_name }} 版权所</p>
    </div>
</footer>
