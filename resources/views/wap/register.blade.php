                ...
                <div class="m_login-form">
                    <form id="form1"  action="{{ route('wap.register.post') }}" method="post" name="form1">
                        ...
                        <div class="m_login-field">
                            ...
                            <input id="zcname" name="name" type="text" placeholder="用户名(7-10位字符)" minlength="7" maxlength="10">
                        </div>
                        <div class="m_login-field">
                        ...
                        <div class="m_login-field">
                            ...
                            <input id="passwdse" name="password_confirmation" type="password" placeholder="再次输入密码" minlength="6" maxlength="14">
                        </div>
                        <div class="m_login-field">
